        ...
        <div class="container" class="bg-light" >
            <div class="card mt-5" style="border: none">
                <div class="bg-light" style="margin-left: -10px;display: flex;align-items: center;gap: 5px">
                   ...
                   <strong>TAMBAH DATA PRODUK</strong><br><br><br><br>
                </div>
                <div class="bg-light">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group">
                            ...
                            <div style="display: flex;align-items: center;gap: 5px">
                                <i style="font-size: 2rem" class='bx bx-user-pin'></i>
                                 <input autocomplete="off" type="text" name="nama" class="form-control" placeholder="Nama produk ..">
                            </div>
                        ...
                        <div class="form-group">
                            <label style="margin-left: 35px">Kategori</label>
                            <div style="display: flex;gap: 5px; ">
                                <i style="font-size: 2rem" class='bx bx-user-pin'></i>
                                <select style="border-radius: 5px;width: 100%;height:32px;padding: 4px"  name="kategori" id="kategori">
                        ...
                        <div class="form-group">
                            ...
                            <div style="display: flex;align-items: center;gap: 5px">
                                <i style="font-size: 2rem" class='bx bx-purchase-tag'></i>
                                 <input autocomplete="off" name="harga" class="form-control" placeholder="harga produk .."></input>
                            </div>
                        ...
                        <div style="display: flex;align-items: center;gap: 5px">
                            ...
                            <input autocomplete="off" name="berat" class="form-control" placeholder="berat produk .."></input>
                        </div>    
                        ...
                        <div style="display: flex;align-items: center;gap: 5px">
                            ...
                            <input autocomplete="off" type="file" name="foto" class="form-control upload-box" placeholder="foto produk .."></input>
                        </div>    
                        ...
                        <div style="display: flex;align-items: center;gap: 5px">
                            ...
                            <input autocomplete="off" name="deskripsi" class="form-control" placeholder="deskripsi produk .."></input>
                        </div>
                        ...
                        <div style="display: flex;align-items: center;gap: 5px">
                            ...
                            <input autocomplete="off" name="stok" class="form-control" placeholder="stok produk .."></input>
                        </div>
